...
<header id="header-part">
    ...
    <section id="course-part" class="pt-70 pb-80 services-section">
        <div class="container">
            <!-- <div class="row">
                <div class="col-lg-6">
            ...
            <h4 class="text-center">We provide the following services among others:</h4>
            <div class="row mt-50">
                <div class="col-lg-3">
                    <i class="fa fa-graduation-cap fa-4x pt-30 pb-30"></i><br>
                    <p>Professional Video & Film production classes (online and face-to-face training, internships)</p>
                </div>
                <div class="col-lg-3">
                    <i class="fa fa-film fa-4x pt-30 pb-30"></i><br>
                    <p>Film production (feature film, short film and documentaries)</p>
                </div>
                <div class="col-lg-3">
                    <i class="fa fa-bullhorn fa-4x pt-30 pb-30"></i><br>
                    <p>Institutional film production (Advertisements, promotional videos, flash mob)</p>
                </div>
                <div class="col-lg-3">
                    <i class="fa fa-television fa-4x pt-30 pb-30"></i><br>
                    <p>TV content production (entertainment news, daily magazine, etc.)</p>
                </div>
            </div> <!-- course slied -->
        </div> <!-- container -->
    </section>
    ...
    <section id="course-part" class="pt-80 pb-115">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-45">
            ...
            <div class="row course-slied mt-30">
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        ...
                        <div class="cont">
                            <a href="single_course.html"><h4>Cinematrography with natural Light</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        ...
                        <div class="cont">
                            <a href="single_course.html"><h4>Directing experimental short films</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        ...
                        <div class="cont">
                            <a href="single_course.html"><h4>Documentary filmmaking from scratch</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        ...
                        <div class="cont">
                            <a href="single_course.html"><h4>Basic Lighting for Audiovisual Projects</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        ...
                        <div class="cont">
                            <a href="single_course.html"><h4>All kit you need to start filmmaking career</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
            </div> <!-- course slied -->
